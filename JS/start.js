/*
	...
	Данная версия выложена на сайт https://tik-tak-toe-delta.web.app

	Замеченные ошибки:
	- если несколько человек уже в игре, после нажатия на кнопку "Новая игра" некорректро отображается поле "кто вы в текущей игре".

	Что можно доделать:
	- см комментарии // ToDo: в коде
*/
